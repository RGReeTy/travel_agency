...
public final class TourDAOParamTest {

    public TourDAOParamTest() {
    }

    public static final String SELECT_ALL_TOURS = "SELECT * FROM testdb.tours";
    ...
    public static final String SELECT_ALL_HOTELS = "SELECT id_Hotel, Title, country, City, Stars, Free_rooms," +
            "Type, Min_price_per_room, Url_wallpaper FROM testdb.hotel JOIN testdb.nutrition ON Nutrition=id_Nutrition";
    public static final String SELECT_ALL_TOURS_BY_USER_ID = "SELECT tours.id_Tour, tours.Title, TypeOfTour, " +
            ...
            "FROM testdb.tours JOIN typeoftour ON Type=id_TypeOfTour\n" +
            "JOIN discount ON tours.id_Discount = discount.id_Discount\n" +
    ...
    public static final String SELECT_ALL_DEFRAYAL_FOR_USER_BY_USER_ID = "SELECT id_Defrayal, Date_of_payment, Title, Count, Payment_percentage, defrayal.Id_User,\n" +
            "      Login, Size_of_discount, Annotation FROM testdb.defrayal JOIN tours ON  defrayal.Id_Tour=tours.id_Tour\n" +
    ...
    public static final String UPDATE_DEFRAYAL = "UPDATE testdb.defrayal SET Payment_percentage=?, Annotation=? WHERE id_Defrayal=?";
    public static final String SELECT_ALL_DEFRAYAL = "SELECT id_Defrayal, Date_of_payment, Title, Count, Payment_percentage, defrayal.Id_User, Login,\n" +
            "Size_of_discount, Annotation FROM testdb.defrayal JOIN tours ON defrayal.Id_Tour=tours.id_Tour\n" +
            "    JOIN testdb.users ON defrayal.Id_User=users.id_User\n" +
    ...
    public static final String SELECT_ALL_DEFRAYAL_FOR_USER_BY_USER_LOGIN = "SELECT id_Defrayal, Date_of_payment, Title, Count, Payment_percentage, Login,\n" +
            "       Size_of_discount, Annotation, users.id_User FROM testdb.defrayal JOIN tours ON  defrayal.Id_Tour=tours.id_Tour\n" +
            "    JOIN discount ON defrayal.id_Discount=discount.id_Discount\n" +
            "    JOIN users ON defrayal.Id_User=users.id_User WHERE Login = ?";
    public final static String INSERT_NEW_TOUR = "INSERT INTO testdb.tours(id_Tour, Title, Price, Type," +
            "Hot_tour, Number_of_places, Date_start, Date_end, id_Discount, id_Hotel, Description, Url_wallpaper) " +
            "VALUES(?,?,?,?,?,?,?,?,?,?,?,?)";
    public final static String INSERT_NEW_DEFRAYAL = "INSERT INTO  testdb.defrayal(id_Defrayal, Date_of_payment, Id_Tour, " +
            "Count, Payment_percentage, Id_User, id_Discount, Annotation) VALUES (?,?,?,?,?,?,?,?)";
    public final static String FIND_MAX_VALUE_TOUR_ID = "SELECT MAX(id_Tour) FROM testdb.tours";
    public final static String FIND_MAX_VALUE_DEFRAYAL_ID = "SELECT MAX(id_Defrayal) FROM testdb.defrayal";
    public final static String GET_ALL_TYPES_OF_TOURS = "SELECT * FROM testdb.typeoftour";
    public final static String SELECT_ALL_DISCOUNTS = "SELECT * FROM testdb.discount";
}
